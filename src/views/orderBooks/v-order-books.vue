...
export default {
  components: {VOrderBookTable, VCryptocoinIcon, VTableStandard},
  computed: {
    ...mapState({
  ...
  // data() {
  //   return {
  //     dataLabels: ['PRICE', 'AMOUNT', 'COMMISSION'],
  //     dataKeys: ['price', 'amount', 'commission'],
  //   }
  // },
}
</script>
...
<template>
  <h2 class="c-mode-1 margin-0 t-center">Order books</h2>
...
<!--  </div>-->
<!--  <div-->
<!--      class="w-max  animation-from-hidden-long d-grid  g-gap-1 g-gap-2 m-top-2"-->
<!--      v-for="(pairs, exchangeName) in orderBooks"-->
<!--      :key="exchangeName"-->
<!--  >-->
<!--    <div class="d-grid g-gap-1 grid-template-column-2fr"-->
<!--        v-for="(orderBook, pairName) in pairs"-->
<!--        :key="exchangeName + pairName">-->
<!--&lt;!&ndash;      <div class="font-bold m-bottom-1">&ndash;&gt;-->
<!--&lt;!&ndash;        {{ exchangeName }} — {{ pairName }}&ndash;&gt;-->
<!--&lt;!&ndash;      </div>&ndash;&gt;-->
<!--      <v-order-book-table type="purchases" :order-book="orderBook"/>-->
<!--      <v-order-book-table type="sales" :order-book="orderBook"/>-->
<!--    </div>-->
<!--  </div>-->
<!--  saleLowPrice-->
</template>
